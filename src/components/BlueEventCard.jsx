...
const BlueEventCard = (props) => {
    ...
    return (
      <img alt ='' className={`filter-white backgroundblue blueeventcard ${showComponent && 'visible'} ${transitionOut && 'out'}`} src={eventSVG(statfeed)} />
    )
}

export default BlueEventCard;